...
module twiddle_factor_unified_synthesizable #(
    ...
    // -------------------------------------------------------------------------
    // 1. Scale k into the 0..511 ROM index space
    // -------------------------------------------------------------------------
    ...
    always @(*) begin
        case (n)
            11'd1024: scaled_k =  k;
            11'd512:  scaled_k = {k,  1'b0};
            11'd256:  scaled_k = {k,  2'b00};
            11'd128:  scaled_k = {k,  3'b000};
            11'd64:   scaled_k = {k,  4'b0000};
            11'd32:   scaled_k = {k,  5'b00000};
            11'd16:   scaled_k = {k,  6'b000000};
            11'd8:    scaled_k = {k,  7'b0000000};
            11'd4:    scaled_k = {k,  8'b00000000};
            11'd2:    scaled_k = {k,  9'b000000000};
    ...
    // -------------------------------------------------------------------------
    // 3. ROM — full 512 entries from twiddles_1124.txt
    ...
    always @(*) begin
        case (rom_addr)
            ...
            11'd110: rom_data = 24'h35B129;
            11'd111: rom_data = 24'h35B129;
            11'd112: rom_data = 24'h35B129;
            11'd113: rom_data = 24'h35B129;
            11'd114: rom_data = 24'h35B229;
            11'd115: rom_data = 24'h35B229;
            11'd116: rom_data = 24'h35B229;
            11'd117: rom_data = 24'h35B229;
            11'd118: rom_data = 24'h35B229;
            11'd119: rom_data = 24'h35B229;
