...
class PerformanceEvaluator:
    ...
    def _generate_testbench(self, dut_file, design_name):
        ...
        MODIFIED: Memory arrays now sit in this TB, responding to the top's
        exposed mem_* ports, entirely avoiding BRAM inference during synthesis.
        """
        n          = self.fft_size
        addr_bits  = int(math.log2(n))
        aw         = 11          # Hardcoded width matching the RTL
