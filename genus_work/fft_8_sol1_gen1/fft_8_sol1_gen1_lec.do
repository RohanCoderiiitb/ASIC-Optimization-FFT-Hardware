...
# Generated on: Wed May 27 23:15:09 IST 2026 (Wed May 27 17:45:09 UTC 2026)
...
#set_log_file rtl_fft_8_sol1_gen1_netlistv.log -replace

usage -auto -elapse

# Comparing intermediate 'fv_map' netlist vs. revised netlist.

set_verification_information fv_map_fft_8_sol1_gen1_netlistv_db

read_implementation_information fv/fft_8_sol1_gen1_top -golden fv_map -revised fft_8_sol1_gen1_netlistv
...
read_design -verilog95   -golden -lastmod -noelab fv/fft_8_sol1_gen1_top/fv_map.v.gz
elaborate_design -golden -root {fft_8_sol1_gen1_top}

read_design -verilog95   -revised -lastmod -noelab /home/rohan/Documents/ASIC-Optimization-FFT-Hardware/reports/fft_8_sol1_gen1_netlist.v
elaborate_design -revised -root {fft_8_sol1_gen1_top}

#add_name_alias fv/fft_8_sol1_gen1_top/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/fft_8_sol1_gen1_top/fft_8_sol1_gen1_netlistv.singlebit.original_name.alias.json.gz -revised
...
read_implementation_information fv/fft_8_sol1_gen1_top -revised fv_map
...
delete_search_path -all -design -golden
add_search_path /home/rohan/Documents/ASIC-Optimization-FFT-Hardware/verilog_sources -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  /home/rohan/Documents/ASIC-Optimization-FFT-Hardware/generated_designs/fft_8_sol1_gen1.v
delete_search_path -all -design -golden
add_search_path /home/rohan/Documents/ASIC-Optimization-FFT-Hardware/verilog_sources -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  /home/rohan/Documents/ASIC-Optimization-FFT-Hardware/generated_designs/fft_8_sol1_gen1_top.v
elaborate_design -golden -root {fft_8_sol1_gen1_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fft_8_sol1_gen1_top/fv_map.v.gz
elaborate_design -revised -root {fft_8_sol1_gen1_top}
...
#add_name_alias fv/fft_8_sol1_gen1_top/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff dlat -both
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
#analyze_results -logfiles rtl_fft_8_sol1_gen1_netlistv.log
}
