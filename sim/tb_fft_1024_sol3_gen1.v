...
module tb_fft_1024_sol3_gen1;
    ...
    initial begin : STIM
        ...
        // Open output file
        out_file = $fopen("/home/rohan/Documents/ASIC-Optimization-FFT-Hardware/sim/fft_1024_sol3_gen1_output.txt", "w");
        ...
        $display("\n================================================================");
        $display("  Clock-Cycle Report  --  fft_1024_sol3_gen1  (FFT-1024)");
        $display("================================================================");
        ...
        $fclose(out_file);
        $display("Simulation complete for fft_1024_sol3_gen1. Results in /home/rohan/Documents/ASIC-Optimization-FFT-Hardware/sim/fft_1024_sol3_gen1_output.txt");
        $finish;
    end
