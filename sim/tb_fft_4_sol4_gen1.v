...
module tb_fft_4_sol4_gen1;
    ...
    initial begin
        #51040;
        $display("WATCHDOG TIMEOUT for fft_4_sol4_gen1");
        $finish;
    end
    ...
    initial begin : STIM
        ...
        // Open output file
        out_file = $fopen("/home/rohan/Documents/ASIC-Optimization-FFT-Hardware/sim/fft_4_sol4_gen1_output.txt", "w");
        ...
        $display("\n================================================================");
        $display("  Clock-Cycle Report  --  fft_4_sol4_gen1  (FFT-4)");
        $display("================================================================");
        ...
        for (ti = 0; ti < 11; ti = ti + 1) begin
            ...
            if (!done)
                $display("WARN: done never asserted for test %0d, design fft_4_sol4_gen1", ti);
        ...
        $fclose(out_file);
        $display("Simulation complete for fft_4_sol4_gen1. Results in /home/rohan/Documents/ASIC-Optimization-FFT-Hardware/sim/fft_4_sol4_gen1_output.txt");
        $finish;
    end
