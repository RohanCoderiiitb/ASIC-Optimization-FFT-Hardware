// Auto-generated testbench for fft_1024_sol1_gen2_top
...
module tb_fft_1024_sol1_gen2;
    ...
    initial begin
        #6800640;
        $display("WATCHDOG TIMEOUT for fft_1024_sol1_gen2");
        $finish;
    end
    ...
    initial begin : STIM
        ...
        // Open output file
        out_file = $fopen("/home/rohan/Documents/ASIC-Optimization-FFT-Hardware/sim/fft_1024_sol1_gen2_output.txt", "w");
        ...
        $display("\n================================================================");
        $display("  Clock-Cycle Report  --  fft_1024_sol1_gen2  (FFT-1024)");
        $display("================================================================");
        ...
        for (ti = 0; ti < 11; ti = ti + 1) begin
            ...
            if (!done)
                $display("WARN: done never asserted for test %0d, design fft_1024_sol1_gen2", ti);
        ...
        $fclose(out_file);
        $display("Simulation complete for fft_1024_sol1_gen2. Results in /home/rohan/Documents/ASIC-Optimization-FFT-Hardware/sim/fft_1024_sol1_gen2_output.txt");
        $finish;
    end
